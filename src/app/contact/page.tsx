...
export default function ContactUs() {
  return (
    <div>
      ...
      {/* ========== END HEADER ========== */}
      {/* Hero */}
      <SubHero title="Contact Us" bgImage="/images/contacthero.png" />
              ...
              <div className="grid sm:grid-cols-2 gap-4 sm:gap-6 md:gap-8 lg:gap-12">
                <div className="flex gap-4">
                  ...
                  <div className="grow">
                    ...
                    <p>
                      <a
                        className="relative inline-block font-medium text-black before:absolute before:bottom-0.5 before:start-0 before:-z-[1] before:w-full before:h-1 before:bg-lime-400 hover:before:bg-black focus:outline-none focus:before:bg-black dark:hover:before:bg-white dark:focus:before:bg-white"
                        href="mailto:example@site.so"
                      >
                        support@prominentaustralia
                      </a>
                    </p>
                  </div>
                </div>
