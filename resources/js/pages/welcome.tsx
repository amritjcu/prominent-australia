                                    ...
                                    <div className="max-w-7xl text-center mx-auto">
                                        ...
                                        <div className="mt-24 max-w-7xl">
                                            <h1 className="block font-semibold text-gray-800 text-4xl md:text-5xl lg:text-6xl">
                                                You Choose The Color and We
                                                Create The Coating For You
                                            </h1>
                                        </div>
                                        {/* End Title */}
                                        <div className="mt-5 max-w-4xl mx-auto">
                                            <p className="text-lg text-gray-800">
                                                ...
                                                Custom Coatings – Choose Any
                                                Color, and We'll Bring Your
                                                Vision to Life! Our expert team
                                                is ready to craft the perfect
                                                coating solution tailored to
                                                your unique style and needs.
                                                Quality, durability, and
                                                precision in every shade you
                                                desire.
                                            </p>
                                        </div>
                                        {/* Buttons */}
                                    ...
                                    <div className="space-y-6 sm:space-y-8">
                                        ...
                                        <div className="space-y-2 md:space-y-4">
                                            <h2 className="font-bold text-3xl lg:text-5xl text-gray-800 leading-tight">
                                                Powder Coating Supplier in
                                                Australia
                                            </h2>
                                            <p className="text-gray-500 leading-7">
                                                The trusted supplier and
                                                distributor of Powder coating in
                                                Australia. Prominent Australia
                                                Pty Ltd is a leading supplier
                                                and distributor in Australia for
                                                customers who are demanding
                                                high-quality powder and
                        ...
                        <div className="px-4 sm:px-6 lg:px-8 lg:py-16 py-10">
                            <div className="relative py-6 md:py-10 overflow-hidden before:absolute before:top-0 before:start-0 before:z-10 before:w-20 before:h-full before:bg-gradient-to-r before:from-white before:to-transparent after:absolute after:top-0 after:end-0 after:w-20 after:h-full after:bg-gradient-to-l after:from-white after:to-transparent">
                                ...
                                <div className="flex justify-between items-center gap-x-4 max-w-7xl mx-auto">
                                    <svg
                                        className="w-14 md:w-20 h-auto text-red-600 mx-auto"
                                    ...
                                    <svg
                                        className="hidden sm:block w-14 md:w-20 h-auto text-red-600 mx-auto"
                                        xmlns="http://www.w3.org/2000/svg"
                                        x={0}
                                        y={0}
                                        viewBox="0 0 88 22"
                                    ...
                                    <svg
                                        className="hidden md:block w-14 md:w-20 h-auto text-red-600 mx-auto"
                                        fill="none"
                                        xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 107 32"
                                    >
                                ...
                                <div className="grid sm:grid-cols-2 lg:grid-cols-3 items-center gap-12">
                                    ...
                                    <div className="border border-gray-300 rounded-lg p-6 flex flex-col h-80 items-center justify-center text-center">
                                        ...
                                        <div className="mt-3">
                                            ...
                                            <p className="mt-1 text-gray-600">
                                                Suitable where maximum corrosion
                                                and chemical resistance is
                                                required.
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="border border-gray-300 p-6 rounded-lg flex flex-col h-80 items-center justify-center text-center">
                                        ...
                                        <div className="mt-3">
                                            ...
                                            <p className="mt-1 text-gray-600">
                                                A hybrid powder is a mixture of
                                                epoxy and polyester resins,
                                                which forms a hard film with
                                                good resistance.
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="border border-gray-300 rounded-lg p-6 flex flex-col h-80 items-center justify-center text-center">
                                        ...
                                        <div className="mt-3">
                                            ...
                                            <p className="mt-1 text-gray-600">
                                                Designed for the projects that
                                                have extreme high heat
                                                resistance.
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="border border-gray-300 rounded-lg p-6 flex flex-col h-80 items-center justify-center text-center">
                                        ...
                                        <div className="mt-3">
                                            ...
                                            <p className="mt-1 text-gray-600">
                                                Alternate to polyester powder,
                                                it has polyurethanic resins that
                                                gives strong protection film.
                                            </p>
                                        </div>
                                    </div>
                                    {/* End Icon Block */}
                                    ...
                                    <div className="border border-gray-300 p-6 rounded-lg flex flex-col h-80 items-center justify-center text-center">
                                        ...
                                        <div className="mt-3">
                                            ...
                                            <p className="mt-1 text-gray-600">
                                                Popularly known as thermoplastic
                                                powder coating and provides good
                        ...
                        <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-24">
                            ...
                            <div className="mt-5 max-w-3xl text-center mx-auto">
                                <p className="text-lg text-gray-600">
                                    Find the one that works for you from the
                                    most popular colours for your industry
                                </p>
                                <p className="text-lg text-gray-600">
                            ...
                            <div className="mt-8 gap-3 flex justify-center">
                                <a
                                    className="px-12 inline-flex justify-center items-center gap-x-3 text-center bg-red-600 text-white text-sm font-medium rounded-md focus:outline-none focus:from-violet-600 focus:to-red-600 py-3 px-4"
                                    href="#"
                                >
                                    Buy Now
                                </a>
                                <button className="px-12 border border-red-600 text-sm font-medium rounded-md focus:outline-none focus:from-violet-600 focus:to-red-600 py-3 px-4">
                                    Learn More
                                </button>
                            </div>
                            {/* End Buttons */}
                                    ...
                                    <div className="mt-3 grid space-y-3 text-sm">
                                        <p>
                                            <a
                                                ...
                                                href="#"
                                            >
                                                Heat Resistance Powder Upto 650°
                                                C
                                            </a>
                                        </p>
                                        <p>
